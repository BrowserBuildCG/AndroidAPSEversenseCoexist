...
The E365 transmitter is not able to support multiple connections to the same device due to the security protocol. The E3 180 day transmitter does not have this limitation.

From Official E365 Eversense app to AAPS app:
...
From AAPS app to Official E365 Eversense app:
...
With Eversense added to AAPS you get direct connection to your transmitter for glucose readings and can configure alert notifications. Because the E365 transmitter can only connect to one app at a time, you must first disconnect from the Eversense 365 app before you can connect to the AAPS app.
